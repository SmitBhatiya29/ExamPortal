  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isRegistering && selectedType === 'teacher') {
        ...
        response = await axios.post('https://examportal-3-tf7a.onrender.com/api/teachers/signup', {
          name,
          email,
          institute,
          password
        ...
        // Teacher login
        response = await axios.post('https://examportal-3-tf7a.onrender.com/api/teachers/login', {
          email,
          password
        });
      } else if (selectedType === 'student') {
        // Student login
        response = await axios.post('https://examportal-3-tf7a.onrender.com/api/students/login', {
          email,
          password
        });
      }
