...
const StudentDashboard = ({ onLogout }) => {
  ...
  useEffect(() => {
    ...
    axios.get('https://examportal-3-tf7a.onrender.com//api/students/profile', {
  ...
  useEffect(() => {
    ...
    if (!token || !sid) return;
    axios.get(`https://examportal-3-tf7a.onrender.com//api/quiz-results/student/${sid}`)
      .then(res => {
  ...
  useEffect(() => {
    const sid = studentId || localStorage.getItem('studentId');
    if (!sid) return;
    axios.get(`https://examportal-3-tf7a.onrender.com//api/quiz-results/student/${sid}/chapter-summary`)
      .then(res => {
